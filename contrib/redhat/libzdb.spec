#
# spec file for package libzdb (Version 3.4.1)
#
...
%changelog
* Tue Sep 23 2025 Tom Ivar Helbekkmo <tih@hamartun.priv.no>
- Hand picked last version before use of "include <format>" broke on RHEL
